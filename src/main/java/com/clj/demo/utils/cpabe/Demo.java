package com.clj.demo.utils.cpabe;

public class Demo {
	final static boolean DEBUG = true;

	static String dir = "C:\\Users\\76477\\IdeaProjects\\demo\\src\\main\\java\\com\\clj\\demo\\utils\\cpabe\\textdata";
	...
	static String encfile = dir + "/input.cpabe.txt";
	static String decfile = dir + "/output.pdf";
	...
	public static void main(String[] args) throws Exception {
		...
		String label_attr = "area:1 level:2 User:test2 User:test9 ";
		String label_policy = "area:1 level:2 User:test2 User:test3 User:test4 User:test5 begin>=20120901 begin<=20180920 3of8";
		...
		//while(index<100) {
			...
			test.enc(pubfile, label_policy, inputfile, encfile);
			//println("//end to enc");

			//println("//start to keygen");
			test.keygen(pubfile, prvfile, mskfile, label_attr);
