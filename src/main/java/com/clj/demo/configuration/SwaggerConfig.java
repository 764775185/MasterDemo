...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //扫描包路径
                .apis(RequestHandlerSelectors.basePackage("com.clj.demo"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                //页面标题
                .title("CLJ_Graduation Project")
                //描述
                .description("云数据安全存储与查询系统接口文档")
                //创建人
                .contact(new Contact("华中科技大学-曹琳婧", "", "764775185@qq.com"))
                //版本号
                .version("1.0")
                .build();
