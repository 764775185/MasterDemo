...
public class Demo {
	...
	static String inputfile = "textKey";
	...
	public static void main(String[] args) throws Exception {
		...
		String label_attr = "area:1 level:2 User:clj Id:M201873221";
		String label_policy = "area:1 level:2 User:clj begin=20191010 end=20200612 3of5";
		println("policy: "+label_policy);
		println("attr: "+label_attr);
		...
		//while(index<100) {
		    ...
		    println("input_fileKey: "+inputfile);
		    println("");
			//println("//start to enc");
		    String strings = test.enc(pubfile, label_policy, inputfile);
		    println("E: "+strings);
		    println("");
			//println("//end to enc");

			//println("//start to keygen");
		    String p = test.keygen(pubfile, mskfile, label_attr);
		    println("sk: "+p);
		    println("");
		    ...
		    String deckey =test.dec(pubfile, p, strings);
		    println("output_filekey: "+deckey);
			//println("//end to dec");
			//index++;
		//}
	}
